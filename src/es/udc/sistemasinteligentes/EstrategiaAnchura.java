...
public class EstrategiaAnchura implements EstrategiaBusqueda {
    ...
    public Nodo[] soluciona(ProblemaBusqueda p) throws Exception {
        ...
        // Frontera: cola para implementar BFS (primero en entrar, primero en salir)
        ...
        int i = 1;
        System.out.println((i++) + " - Empezando búsqueda en anchura desde " + nodoInicial.getEstado());

        while (!frontera.isEmpty()) {
            // Extraemos el primer nodo de la cola (el más antiguo)
